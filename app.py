...
if not TOKEN:
    ...
    print("Please add TELEGRAM_BOT_TOKEN to your Render Environment settings.")
    exit(1)

if not WEBAPP_URL:
    print("CRITICAL ERROR: WEBAPP_URL is not set in environment variables.")
    print("Please add WEBAPP_URL to your Render Environment settings.")
    exit(1)
